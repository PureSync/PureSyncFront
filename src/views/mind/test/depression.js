...
const Depression = () => {
  ...
  useEffect(() => {
    axios.get(process.env.REACT_APP_HOST_URL + '/api/test/depression', {
      headers: {
  ...
  const goToResult = async () => {
    ...
    try {
      const response = await axios.get(process.env.REACT_APP_HOST_URL + `/api/test/depression/answer/${testSeq}`, {
        headers: {
          Authorization: `Bearer ${access_token}`
        }
      });
      ...
      if (ansSeqExists !== null) {
        await axios.put(process.env.REACT_APP_HOST_URL + `/api/test/depression/${testSeq}`, data, {
          headers: {
            Authorization: `Bearer ${access_token}`
          }
        });

        const updatedResponse = await axios.get(process.env.REACT_APP_HOST_URL + `/api/test/depression/answer/${testSeq}`, {
          headers: {
            Authorization: `Bearer ${access_token}`
          }
        });
        ...
        navigate('/mind/test/depressionResult', {
          state: {
        ...
        await axios.post(process.env.REACT_APP_HOST_URL + '/api/test/depression', data, {
          headers: {
            Authorization: `Bearer ${access_token}`
          }
        });

        const createdResponse = await axios.get(process.env.REACT_APP_HOST_URL + `/api/test/depression/answer/${testSeq}`, {
          headers: {
            Authorization: `Bearer ${access_token}`
          }
        });
